---
title: Move-Fire Action
type: rule
tags: [move-fire, movement, direct-fire, action]
...
| Side | [[glossary|Dice Roll Modifier (DRM)]] |
|------|-----|
| **NATO** | **-1** |
| **Russia** | **-2** |
...
- **Hit and run**: Move within 250m of an enemy in Dense Wood/Urban, Fire using the 250m [[line-of-sight|Line of Sight (LoS) exception]], then Move back to at least 250m away
- **Shoot and scoot**: Fire during movement, then continue to a position behind cover
- **Suppressive advance**: Move toward an objective while engaging defenders
