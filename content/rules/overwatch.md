---
title: Overwatch & Reactive Fire
type: rule
tags: [overwatch, reactive-fire, defense, action]
...
A [[force-elements|Force Element (FE)]] on the **non-activating side** with an Overwatch marker may take a [[direct-fire|Direct Fire]] Action against a **Moving or Assaulting** enemy [[force-elements|FE]]. This is the only Action the non-activating side can take during an opponent's activation.
...
In either case, the "Fire" part of a [[move-fire|Move-Fire]] Action may be **cancelled** at this point.

### Reactive Fire in Assaults
...
A [[task-groups|Task Group (TGp)]] can have a mix of [[force-elements|FEs]] with and without Overwatch markers:
- An [[force-elements|FE]] that Reactive Fires cannot activate again that turn
- Other [[force-elements|FEs]] in the same Task Group **can still be activated** normally when the Task Group activates

> [!tip]
> Overwatch is powerful for defense. In the [[rulebook-final|example of play]], both NATO Task Groups begin with Overwatch Actions to wait for Russian movements and Reactive Fire with their NLAWs and Javelins.
