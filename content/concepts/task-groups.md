...
title: Task Groups
type: concept
tags: [organization, activation, orbat]
...
> [!note]
> While an FE is activating, the only action the non-activating side can take is [[overwatch#Reactive Fire|Reactive Fire]].

### FEs in Reorg
[[force-elements|FEs]] with a **Reorg marker** cannot be activated that turn. Other [[force-elements|FEs]] in the same Task Group can still activate normally.

### Embedded & Mounted FEs
- An [[stacking|Embedded]] [[force-elements|SECT]] takes the same actions as its Tracked [[force-elements|PL]], unless Detaching
- A [[stacking|Mounted]] Foot [[force-elements|PL]] cannot take any action except Move (to Dismount) or [[assault|Assault]]

## Task Group Markers

Double-sided tokens:
- **Front (unstriped)**: Task Group has not yet activated this turn
- **Back (striped)**: Task Group has been activated
...
### Mortar Task Groups
Mortar [[force-elements|FEs]] always have their own Task Group. Since they are [[force-elements|FEs]] that move on the map, they receive **both** manoeuvre [[orders|Orders]] and a [[fire-plans|Fire Plan]] on the [[sync-matrix|Sync Matrix]].

### A1 Echelon Task Groups (Advanced Mode)
